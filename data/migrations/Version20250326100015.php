 ...
 */
final class Version20250326100015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__parcel AS SELECT id, parcel_id, description, dimensions, weight, delivery_service, supplier, customer_id, parcel_tracking_id FROM parcel');
        ...
        $this->addSql('INSERT INTO parcel (id, parcel_id, description, dimensions, weight, delivery_service, supplier, customer_id, parcel_tracking_id) SELECT id, parcel_id, description, dimensions, weight, delivery_service, supplier, customer_id, parcel_tracking_id FROM __temp__parcel');
