 ...
 */
final class Version20250326060601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE parcel (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parcel_id INTEGER NOT NULL, description VARCHAR(255) NOT NULL, dimensions VARCHAR(255) NOT NULL, weight VARCHAR(255) NOT NULL, delivery_service VARCHAR(255) NOT NULL, supplier VARCHAR(255) NOT NULL, customer_id INTEGER DEFAULT NULL, CONSTRAINT FK_C99B5D609395C3F3 FOREIGN KEY (customer_id) REFERENCES parcel (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C99B5D60BF396750 FOREIGN KEY (id) REFERENCES parcel (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
